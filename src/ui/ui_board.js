...
class UIBoard extends GWE.UIWidget {
  constructor() {
    super({
      ...
      <div class="UIBoard-fields">
        <div class="UIBoard-field" data-duelist-index="0">
          <div class="UIBoard-field-zone js-zone" data-duelist-index="0" data-location="LOCATION.MZONE" style="top:80px; left:327px;"></div>
          <div class="UIBoard-field-zone js-zone" data-duelist-index="0" data-location="LOCATION.MZONE" style="top:80px; left:377px;"></div>
          <div class="UIBoard-field-zone js-zone" data-duelist-index="0" data-location="LOCATION.MZONE" style="top:80px; left:427px;"></div>
          <div class="UIBoard-field-zone js-zone" data-duelist-index="0" data-location="LOCATION.SZONE" style="top:10px; left:327px;"></div>
          <div class="UIBoard-field-zone js-zone" data-duelist-index="0" data-location="LOCATION.SZONE" style="top:10px; left:377px;"></div>
          <div class="UIBoard-field-zone js-zone" data-duelist-index="0" data-location="LOCATION.SZONE" style="top:10px; left:427px;"></div>
          <div class="UIBoard-field-zone js-zone" data-duelist-index="0" data-location="LOCATION.FZONE" style="top:150px; left:10px;"></div>
          <div class="UIBoard-field-zone js-zone" data-duelist-index="0" data-location="LOCATION.GRAVEYARD" style="top:80px; left:10px;"></div>
          <div class="UIBoard-field-zone js-zone" data-duelist-index="0" data-location="LOCATION.DECK" style="top:10px; left:10px;"></div>
          <div class="UIBoard-field-zone js-zone" data-duelist-index="0" data-location="LOCATION.HAND" style="top:10px; right:10px;"></div>
        </div>
        <div class="UIBoard-field" data-duelist-index="1">
          <div class="UIBoard-field-zone js-zone" data-duelist-index="1" data-location="LOCATION.MZONE" style="bottom:80px; right:327px;"></div>
          <div class="UIBoard-field-zone js-zone" data-duelist-index="1" data-location="LOCATION.MZONE" style="bottom:80px; right:377px;"></div>
          <div class="UIBoard-field-zone js-zone" data-duelist-index="1" data-location="LOCATION.MZONE" style="bottom:80px; right:427px;"></div>
          <div class="UIBoard-field-zone js-zone" data-duelist-index="1" data-location="LOCATION.SZONE" style="bottom:10px; right:327px;"></div>
          <div class="UIBoard-field-zone js-zone" data-duelist-index="1" data-location="LOCATION.SZONE" style="bottom:10px; right:377px;"></div>
          <div class="UIBoard-field-zone js-zone" data-duelist-index="1" data-location="LOCATION.SZONE" style="bottom:10px; right:427px;"></div>
          <div class="UIBoard-field-zone js-zone" data-duelist-index="1" data-location="LOCATION.FZONE" style="bottom:150px; right:10px;"></div>
          <div class="UIBoard-field-zone js-zone" data-duelist-index="1" data-location="LOCATION.GRAVEYARD" style="bottom:80px; right:10px;"></div>
          <div class="UIBoard-field-zone js-zone" data-duelist-index="1" data-location="LOCATION.DECK" style="bottom:10px; right:10px;"></div>
          <div class="UIBoard-field-zone js-zone" data-duelist-index="1" data-location="LOCATION.HAND" style="bottom:10px; left:10px;"></div>
        </div>
      </div>`
    });
    ...
    let spellZone00 = this.node.querySelectorAll(`.js-zone[data-duelist-index="0"][data-location="LOCATION.SZONE"]`)[0];
    ...
    let spellZone01 = this.node.querySelectorAll(`.js-zone[data-duelist-index="0"][data-location="LOCATION.SZONE"]`)[1];
    ...
    let spellZone02 = this.node.querySelectorAll(`.js-zone[data-duelist-index="0"][data-location="LOCATION.SZONE"]`)[2];
    ...
    let monsterZone00 = this.node.querySelectorAll(`.js-zone[data-duelist-index="0"][data-location="LOCATION.MZONE"]`)[0];
    ...
    let monsterZone01 = this.node.querySelectorAll(`.js-zone[data-duelist-index="0"][data-location="LOCATION.MZONE"]`)[1];
    ...
    let monsterZone02 = this.node.querySelectorAll(`.js-zone[data-duelist-index="0"][data-location="LOCATION.MZONE"]`)[2];
    ...
    let handZone00 = this.node.querySelectorAll(`.js-zone[data-duelist-index="0"][data-location="LOCATION.HAND"]`)[0];
    ...
    let fieldZone00 = this.node.querySelectorAll(`.js-zone[data-duelist-index="0"][data-location="LOCATION.FZONE"]`)[0];
    ...
    let graveyardZone00 = this.node.querySelectorAll(`.js-zone[data-duelist-index="0"][data-location="LOCATION.GRAVEYARD"]`)[0];
    ...
    let deckZone00 = this.node.querySelectorAll(`.js-zone[data-duelist-index="0"][data-location="LOCATION.DECK"]`)[0];
    ...
    let spellZone10 = this.node.querySelectorAll(`.js-zone[data-duelist-index="1"][data-location="LOCATION.SZONE"]`)[0];
    ...
    let spellZone11 = this.node.querySelectorAll(`.js-zone[data-duelist-index="1"][data-location="LOCATION.SZONE"]`)[1];
    ...
    let spellZone12 = this.node.querySelectorAll(`.js-zone[data-duelist-index="1"][data-location="LOCATION.SZONE"]`)[2];
    ...
    let monsterZone10 = this.node.querySelectorAll(`.js-zone[data-duelist-index="1"][data-location="LOCATION.MZONE"]`)[0];
    ...
    let monsterZone11 = this.node.querySelectorAll(`.js-zone[data-duelist-index="1"][data-location="LOCATION.MZONE"]`)[1];
    ...
    let monsterZone12 = this.node.querySelectorAll(`.js-zone[data-duelist-index="1"][data-location="LOCATION.MZONE"]`)[2];
    ...
    let handZone10 = this.node.querySelectorAll(`.js-zone[data-duelist-index="1"][data-location="LOCATION.HAND"]`)[0];
    ...
    let fieldZone10 = this.node.querySelectorAll(`.js-zone[data-duelist-index="1"][data-location="LOCATION.FZONE"]`)[0];
    ...
    let graveyardZone10 = this.node.querySelectorAll(`.js-zone[data-duelist-index="1"][data-location="LOCATION.GRAVEYARD"]`)[0];
    ...
    let deckZone10 = this.node.querySelectorAll(`.js-zone[data-duelist-index="1"][data-location="LOCATION.DECK"]`)[0];
  ...
  setDuel(duel) {
    for (let slot of this.slots) {
      if (slot instanceof CardSlotWidget) slot.setCard(null);
      else if (slot instanceof StackSlotWidget) slot.setCards(null);
    }
