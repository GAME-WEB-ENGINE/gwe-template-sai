...
class UIDuelist extends GWE.UIWidget {
  ...
  update() {
    if (this.duelist) {
      this.node.querySelector('.js-picture').innerHTML = `<img class="UIDuelist-picture-img" src="${this.duelist.getPictureFile()}">`;
      ...
      this.node.querySelector('.js-picture').innerHTML = '';
